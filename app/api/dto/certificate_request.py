...
class CertificateRequestBaseDTO(DTO):
    id: UUID
...
class CertificateRequestSummaryDTO(CertificateRequestBaseDTO): ...


class CertificateRequestDetailDTO(CertificateRequestSummaryDTO):
